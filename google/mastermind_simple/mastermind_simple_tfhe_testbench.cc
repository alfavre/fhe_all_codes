...
#include "transpiler/examples/mastermind_simple/mastermind_simple_tfhe.h"

// to run:"bazel run //transpiler/examples/mastermind_simple:mastermind_simple_tfhe_testbench"
...
int main(int argc, char** argv) {
    ...
    while (attempts_made < MAX_ATTEMPTS &&
        ...
        XLS_CHECK_OK(mastermind_simple(cipher_result.get(), ciphertext_code.get(),
