...
#include "transpiler/examples/mastermind_optimized/mastermind_optimized_tfhe.h"

// to run:"bazel run //transpiler/examples/mastermind_optimized:mastermind_optimized_tfhe_testbench"
...
// this is basically stolen from simple sum
int main(int argc, char** argv) {
    ...
    while (attempts_made < MAX_ATTEMPTS &&
        ...
        XLS_CHECK_OK(mastermind_optimized(cipher_result.get(), ciphertext_code.get(),
        ...
        cout << "Result is: " << oct << result << "\t" << bitset<6>(result) <<endl;
